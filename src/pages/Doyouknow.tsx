...
const TravelSafetyStats: React.FC = () => {
  const statsData = [
    {
      icon: <Moon className="w-8 h-8" style={{ color: '#BCB291' }} />,
    ...
    {
      icon: <TrendingUp className="w-8 h-8" style={{ color: '#BCB291' }} />,
    ...
    {
      icon: <AlertTriangle className="w-8 h-8" style={{ color: '#BCB291' }} />,
    ...
    {
      icon: <Car className="w-8 h-8" style={{ color: '#BCB291' }} />,
    ...
    {
      icon: <FileX className="w-8 h-8" style={{ color: '#BCB291' }} />,
    ...
    {
      icon: <Shield className="w-8 h-8" style={{ color: '#BCB291' }} />,
  ...
  return (
    <div 
      className="min-h-screen bg-cover bg-center bg-no-repeat p-9"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10 mt-3 relative">
          <h1 className="text-5xl md:text-6xl font-bold text-black mb-4 relative inline-block">
            Do You Know?
            {/* Underline effect */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-9">
          {statsData.map((stat, index) => (
            <div 
              key={index}
              className="bg-white bg-opacity-90 mt-3 backdrop-blur-sm rounded-3xl p-8 shadow-lg border-2 border-transparent hover:border-2 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 hover:scale-105 group relative overflow-hidden"
              style={{
            ...
            >
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 rounded-3xl" style={{ backgroundColor: '#BCB291' }}></div>
              
              <div className="relative z-10">
                {/* Icon and Title */}
                <div className="flex items-center gap-3 ">
                  <div className="p-2 rounded-full bg-gray-100 group-hover:shadow-lg transition-all duration-300">
                    {stat.icon}
                  </div>
                ...
                {/* Percentage */}
                <div className="mb-4">
                  <span className="text-4xl md:text-5xl font-bold transition-colors duration-300" style={{ color: '#BCB291' }}>
                    {stat.percentage}
                  </span>
                </div>

                {/* Description */}
                <p className="text-gray-900 text-base font-medium mb-6 leading-relaxed group-hover:text-gray-800 transition-colors duration-300">
                  {stat.description}
                </p>

                {/* Source */}
                <div className="relative">
                  <p className="text-gray-700 text-sm font-medium group-hover:text-gray-600 transition-colors duration-300">
                    {stat.source}
                  </p>
                  {/* Bottom accent line */}
                  <div className="absolute -bottom-2 left-0 w-0 h-0.5 group-hover:w-full transition-all duration-700 ease-out" style={{ backgroundColor: '#BCB291' }}></div>
                </div>
              </div>
