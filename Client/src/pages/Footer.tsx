  ...
  return (
    <footer className="bg-black text-white py-6 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center border-t border-gray-800 pt-3">
          ...
          <div className="flex flex-wrap gap-3 justify-center items-center">
            <button
              ...
              className="bg-gray-900 px-3 py-2 rounded-md text-sm hover:bg-gray-800 border border-gray-700 transition-colors"
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <div className="text-xs text-gray-400 leading-tight">Download on the</div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <div className="text-xs text-gray-400 leading-tight">GET IT ON</div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <div className="text-xs text-gray-400 leading-tight">Direct</div>
                  <div className="text-sm font-semibold leading-tight text-white">Android</div>
                </div>
              </div>
            </button>
        ...
        {/* Bottom Legal Links */}
        <div className="flex flex-wrap justify-center lg:justify-end items-center gap-4 mt-5 pt-3 border-t border-gray-800">
