    ...
    <div className="h-screen relative overflow-hidden">
        ...
        <div className="text-center relative w-full mx-auto">
          ...
          <div className="relative z-20">
            ...
            <div className="flex justify-center space-x-3 lg:space-x-4 mb-8 lg:mb-10">
              <div className="w-3 h-3 lg:w-4 lg:h-4 rounded-full animate-pulse" style={{ backgroundColor: '#654321', animationDelay: '0s' }}></div>
              <div className="w-3 h-3 lg:w-4 lg:h-4 rounded-full animate-pulse" style={{ backgroundColor: '#654321', animationDelay: '0.5s' }}></div>
              <div className="w-3 h-3 lg:w-4 lg:h-4 rounded-full animate-pulse" style={{ backgroundColor: '#654321', animationDelay: '1s' }}></div>
            </div>
            ...
            <div className="mx-auto mb-8">
              ...
              >
                ...
                <span className="text-base lg:text-lg xl:text-xl">Get Notified</span>
              </button>
            </div>
          </div>
        </div>
      ...
      {showModal && isAlreadyNotified && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 max-w-md w-full mx-4 transform transition-all duration-300 animate-modalSlideIn">
            <div className="bg-white rounded-2xl p-8 shadow-2xl relative text-center">
